    ...
    def match_rule(self):
        if not self.entity.ips:
                            ...
                            if group:
                                ...
                                if type_match:
                                    ...
                                    if is_filtered:
                                        ...
                                        if category_strength:
                                            ...
                                            if age:
                                                if self.entity.positives != "-":
                                                    ...
                                                    min_positives = age.get(
                                                        self.entity.positives
                                                    )
                                                    max_positives = min_positives.get(
                                                        self.entity.positives
                                                    )
                                                ...
                                                print(
                                                    f"Error: No 'age' Value to Match Rule Set. age: {self.entity.domain_age}"
                                                )
                                                logger.info(
                                                    f"Error: No 'age' Value to Match Rule Set. age: {self.entity.domain_age}"
                                                )
                                            ...
                                            print(
                                                f"Error: No 'category_strength' Value to Match Rule Set. category_strength: {self.entity.category_strength}"
                                            )
                                            logger.info(
                                                f"Error: No 'category_strength' Value to Match Rule Set. category_strength: {self.entity.category_strength}"
                                            )
                                        ...
                                        print(
                                            f"Error: No 'is_filtered' Value to Match Rule Set. is_filtered: {self.entity.is_filtered}"
                                        )
                                        logger.info(
                                            f"Error: No 'is_filtered' Value to Match Rule Set. is_filtered: {self.entity.is_filtered}"
                                        )
                                    ...
                                    print(
                                        f"Error: No Type Match in Rule Set. Type: {self.entity.ticket_type}"
                                    )
                                    logger.info(
                                        f"Error: No Type Match in Rule Set. Type: {self.entity.ticket_type}"
                                    )
                                ...
                                print(
                                    f"Error: No Queue Match in Rule Set. Queue: {self.entity.queue}"
                                )
                                logger.info(
                                    f"Error: No Queue Match in Rule Set. Queue: {self.entity.queue}"
                                )
            ...
            self.entity.response = (
                f"IP addresses detected in the ticket.\nIP Addresses: {self.entity.ips}"
            )
